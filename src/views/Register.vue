  ...
  <ion-page>
    <ion-content class="ion-padding " style="padding-top: calc(var(--ion-safe-area-top))">
      ...
      <div v-if="step === 'email'">
        ...
        <div>
          <ion-item fill="outline" ref="item" class="q-mb-md">
            <ion-label position="floating">Nome e sobrenome</ion-label>
            <ion-input rows="1" v-model="userData.name"></ion-input>
          </ion-item>
          <InputEmail
...
export default {
  ...
  methods: {
    ...
    createUser () {
      ...
      let route = '/auth/createUser'
      if (au && $k) route = '/auth/updateGuestUser'
      const opt = {
        serverName: 'authentication',
        route,
        body: {
